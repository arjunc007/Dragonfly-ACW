...
ParticleShader::ParticleShader() : m_vertexShader(nullptr), m_pixelShader(nullptr), m_layout(nullptr), m_sampleState(nullptr), m_constantBuffer(nullptr)
{
}
...
bool ParticleShader::Initialize(ID3D11Device* device, const HWND hwnd)
{
	//Initialize the vertex and pixel shaders
	if (!InitializeShader(device, hwnd, particleShaderVS, particleShaderPS))
		return false;
	return true;
}
...
bool ParticleShader::Render(ID3D11DeviceContext* deviceContext, const XMMATRIX& world, const XMMATRIX& view, const XMMATRIX& projection) const
{
...
bool ParticleShader::InitializeShader(ID3D11Device* device, const HWND hwnd, const LPCSTR vsName, const LPCSTR psName)
{
	HRESULT result;
	...
	result = D3DCompileFromFile(fxFileName, nullptr, nullptr, vsName, "vs_5_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, 
...
void ParticleShader::OutputShaderErrorMessage(ID3DBlob* errorMessage, const HWND hwnd, const LPCWSTR shaderFilename) const
{
	char* compileErrors;
...
bool ParticleShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, const XMMATRIX& worldMatrix,
...
void ParticleShader::RenderShader(ID3D11DeviceContext* deviceContext) const
{
